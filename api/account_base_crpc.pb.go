...
func (c *baseCrpcClient) BaseInfo(ctx context.Context, req *BaseInfoReq) (*BaseInfoResp, error) {
	...
	var respbody []byte
	if e := c.cc.Call(ctx, _CrpcPathBaseBaseInfo, reqd, func(ctx *crpc.CallContext) error {
		var e error
...
func (c *baseCrpcClient) Ban(ctx context.Context, req *BanReq) (*BanResp, error) {
	...
	reqd, _ := proto.Marshal(req)
	var respbody []byte
	if e := c.cc.Call(ctx, _CrpcPathBaseBan, reqd, func(ctx *crpc.CallContext) error {
		var e error
		if respbody, e = ctx.Recv(); e != nil {
...
func (c *baseCrpcClient) Unban(ctx context.Context, req *UnbanReq) (*UnbanResp, error) {
	...
	reqd, _ := proto.Marshal(req)
	var respbody []byte
	if e := c.cc.Call(ctx, _CrpcPathBaseUnban, reqd, func(ctx *crpc.CallContext) error {
		var e error
		if respbody, e = ctx.Recv(); e != nil {
